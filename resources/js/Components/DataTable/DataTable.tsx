...
export interface DataTableProps<T> extends DataTableSettings {
      ...
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          {pagination?.data?.map((item, index) => {
            return (
              <tr key={index} className={cx(['bg-white border-b hover:bg-gray-50'])}>
                ...
                {actions?.length > 0 && (
                  <td className="px-6 py-4 gap-x-2 flex flex-row flex-wrap">
